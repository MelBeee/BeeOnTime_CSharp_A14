...
namespace Compact_Agenda
{
    ...
    public class TableEvents : SqlExpressUtilities
    {
        ...
        {
            NonQuerySQL("INSERT INTO Events (Title, Description, Starting, Ending, TypeEvenement) VALUES ('" + TextFilter.PrepareForSql(Event.Title) + "','" +
                                                                                                TextFilter.PrepareForSql(Event.Description) + "','" +
                                                                                                DateSQLFormat(Event.Starting) + "','" +
                                                                                                DateSQLFormat(Event.Ending) + "','" + TextFilter.PrepareForSql(Event.TypeEvenement) + "');");
        }
        ...
        public void UpdateEventRecord(Event Event)
        {
            ...
            fieldsValues[5] = TextFilter.PrepareForSql(Event.TypeEvenement);
            UpdateRecord("Events");
        }
